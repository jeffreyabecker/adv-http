...
namespace lumalink::http::routing
{
    namespace ReplaceVariablesDetail
    {
        ...
        std::string ToLowerAsciiString(std::string_view input)
        {
            std::string lower;
        ...
        bool IsTextLikeContentType(std::string_view contentType)
        {
        ...
        bool HasUnsupportedContentEncoding(const HttpHeaderCollection &headers)
        {
        ...
        bool HasUnsupportedTransferEncoding(const HttpHeaderCollection &headers)
        {
        ...
        bool StatusHasNoBody(HttpStatus status)
        {
        ...
        bool shouldApplyFilter(IHttpResponse &response, const ReplaceVariablesOptions &options)
        {
