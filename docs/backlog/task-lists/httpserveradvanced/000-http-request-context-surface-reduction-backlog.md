...
3. [x] Review static-file request resolution and decoration paths and narrow any request-only portions to `HttpRequestContext` while preserving concrete handling where provider or lifecycle integration still needs `HttpContext`.
