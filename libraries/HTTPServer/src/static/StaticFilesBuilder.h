...
namespace HTTPServer::StaticFiles
{
    ...
    protected:
        ...
        void init(HTTPServer::Core::CoreServicesBuilder &coreBuilder)
        {
            if (setupFunc_)
            {
                setupFunc_(*this);
    ...
    public:
        StaticFilesBuilder(FS &fs, HTTPServer::Core::HttpContentTypes &contentTypes, std::function<void(StaticFilesBuilder &)> setupFunc) : setupFunc_(setupFunc),
                                                                                                                                            fileLocator_(fs),
