...
{
    using namespace HTTPServer::Pipeline;
    ...
    HTTPServer::Pipeline::HttpServerBase &HttpContext::server() { return pipeline_.server(); }
    HTTPServer::Pipeline::HttpPipeline &HttpContext::pipeline() { return pipeline_; }
    ...
    HttpContextPipelineHandler::HttpContextPipelineHandler(HTTPServer::Pipeline::HttpPipeline &pipeline)
    ...
    void HttpContextPipelineHandler::onInitialized(HTTPServer::Pipeline::HttpPipeline &pipeline)
    {
        // Default implementation: do nothing
    }

    void HttpContextPipelineHandler::onRequestMessageBegin(HTTPServer::Pipeline::HttpPipeline &pipeline)
    {
    ...
    int HttpContextPipelineHandler::onRequestUrl(HTTPServer::Pipeline::HttpPipeline &pipeline, const uint8_t *at, std::size_t length)
    {
    ...
    int HttpContextPipelineHandler::onRequestHeaderField(HTTPServer::Pipeline::HttpPipeline &pipeline, const uint8_t *at, std::size_t length)
    {
    ...
    int HttpContextPipelineHandler::onRequestHeaderValue(HTTPServer::Pipeline::HttpPipeline &pipeline, const uint8_t *at, std::size_t length)
    {
    ...
    int HttpContextPipelineHandler::onRequestHeadersComplete(HTTPServer::Pipeline::HttpPipeline &pipeline)
    {
        // Store last header
    ...
    int HttpContextPipelineHandler::onRequestBody(HTTPServer::Pipeline::HttpPipeline &pipeline, const uint8_t *at, std::size_t length)
    {
    ...
    int HttpContextPipelineHandler::onRequestMessageComplete(HTTPServer::Pipeline::HttpPipeline &pipeline)
    {
    ...
    void HttpContextPipelineHandler::onRequestParserError(HTTPServer::Pipeline::HttpPipeline &pipeline, HttpParserError error)
    {
    ...
    void HttpContextPipelineHandler::onClientDisconnected(HTTPServer::Pipeline::HttpPipeline &pipeline)
    {
        // Default implementation: do nothing
    }

    void HttpContextPipelineHandler::onResponseStarted(HTTPServer::Pipeline::HttpPipeline &pipeline)
    {
        context_.startedWritingResponse();
    }

    void HttpContextPipelineHandler::onResponseCompleted(HTTPServer::Pipeline::HttpPipeline &pipeline)
    {
        context_.completedWritingResponse();
    }

    // ContextHttpPipelineHandlerFactory implementations
    std::unique_ptr<IHttpPipelineHandler> ContextHttpPipelineHandlerFactory::createHandler(HTTPServer::Pipeline::HttpPipeline &pipeline)
    {
