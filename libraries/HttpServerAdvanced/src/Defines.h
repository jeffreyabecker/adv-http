...
#ifndef HTTPSERVER_ADVANCED_MAX_BUFFERED_POST_BODY_LENGTH
    constexpr ssize_t MAX_BUFFERED_POST_BODY_LENGTH = MAX_BUFFERED_BODY_LENGTH; // 2 KB
#else
    constexpr ssize_t MAX_BUFFERED_POST_BODY_LENGTH = HTTPSERVER_ADVANCED_MAX_BUFFERED_POST_BODY_LENGTH;
#endif
