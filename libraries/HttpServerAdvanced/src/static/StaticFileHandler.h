...
namespace HttpServerAdvanced::StaticFiles
{
    ...
    {
    private:
        HttpServerAdvanced::Core::HttpContentTypes &contentTypes_;
    ...
    public:
        StaticFileHandlerFactory(FileLocator &fileLocator, HttpServerAdvanced::Core::HttpContentTypes &contentTypes) : fileLocator_(fileLocator), contentTypes_(contentTypes)
        {
        }
